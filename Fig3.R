...
names2<-c("Rest F","Cycl F","Rest C","Cycl C")
 

pdf("fig3.pdf") 
boxplot(dados[POS=="F"&MOV=="REP"],dados[POS=="F"&MOV=="PED"], dados[POS=="C"&MOV=="REP"],dados[POS=="C"&MOV=="PED"],ylab="Entropy", names=names2,ylim=c(3,6),outline=FALSE,cex.lab=1.3,cex.axis=1.2,las=2,cex.lab=1.2)
#CurlyBraces(x0=1 , x1=3, y0=4, y1=4, pos = 1, direction = 2, depth=2)
dev.off()
