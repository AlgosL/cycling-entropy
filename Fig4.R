...
names2<-c("Rest F","Cycl F","Rest C","Cycl C","Rest F","Cycl F","Rest C","Cycl C")


pdf("fig4.pdf") 
#par(family = "Ariel Black")
boxplot(dados[POS=="F"&MOV=="REP"&LAT=="DIR"],dados[POS=="F"&MOV=="PED"&LAT=="DIR"],
        dados[POS=="C"&MOV=="REP"&LAT=="DIR"],dados[POS=="C"&MOV=="PED"&LAT=="DIR"],
        dados[POS=="F"&MOV=="REP"&LAT=="ESQ"],dados[POS=="F"&MOV=="PED"&LAT=="ESQ"], 
        dados[POS=="C"&MOV=="REP"&LAT=="ESQ"],dados[POS=="C"&MOV=="PED"&LAT=="ESQ"], ylab="Entropy",names=names2,ylim=c(2.5,6),outline=FALSE,cex.axis=1.2,las=2,cex.lab=1.2)
segments(0.7,2.8,4.3,2.8)
segments(4.7,2.8,8.3,2.8)

segments(0.7,2.8,0.7,2.9)
segments(4.3,2.8,4.3,2.9)

segments(4.7,2.8,4.7,2.9)
segments(8.3,2.8,8.3,2.9)

text(2.5,2.6,"Right",cex=1.2)
text(6.5,2.6,"Left",cex=1.2)
dev.off()
